            ...
            {!formSubmit ? (
                <>
                 <div className="relative flex justify-center w-full lg:w-9/12 mx-auto">
                     <input type="email" className="text-white w-full px-10 py-5 bg-gray-700 mx-auto rounded-md" placeholder="E-mail..." />
                ...
                <h1 className="bg-green-100 text-green-900 w-full lg:w-96 mx-auto text-center font-bold rounded-md py-4">
                    Done!
                </h1>
            )}
